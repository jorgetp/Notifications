...
public class SettingsActivity extends AppCompatActivity {
    ...
    public void getItemsAndRefreshUI() {
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            // items.add(new SettingsAdapter.Switch(getString(R.string.pin_important_senders), MainActivity.getPrefs(this, SETTINGS_PREFS).getBoolean("pin_important_senders", false)));
